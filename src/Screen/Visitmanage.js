      ...
      <View>
        ...
        <View>
           <View style={styles.box1}>
             <Image style={styles.img} source={require('../Image/pic1.png')}/>
             <Image style={styles.img2} source={require('../Image/pic2.png')}/>
           </View>
           <View style={styles.box2}>
             <Image style={styles.img} source={require('../Image/pic3.png')}/>
             <Image style={styles.img2} source={require('../Image/pic4.png')}/>
           </View>
        </View>
        <View style={styles.footer}>
           <Text>Click To See Previous Dashboard Sample</Text>
        </View>
