  ...
  return (
    <View style={styles.maincontainer}>
      ...
      <View style={styles.box}>
        ...
        <Text style={styles.text3}>Observe and Coach</Text>
        <Text style={styles.text4}>Quick</Text>
      </View>
      <View>
        ...
        <View>
           <View style={styles.box1}>
             <Image style={styles.img} source={require('../Image/image1.png')}/>
             <Image style={styles.img2} source={require('../Image/image2.png')}/>
           </View>
           <View style={styles.box2}>
             <Image style={styles.img} source={require('../Image/image3.png')}/>
             <Image style={styles.img2} source={require('../Image/image4.png')}/>
           </View>
        </View>
        <View style={styles.footer}>
           <Text style={styles.click}>Click To See Previous Dashboard Sample</Text>
        </View>
